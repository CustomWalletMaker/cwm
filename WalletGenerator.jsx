...
const WalletGenerator = () => {
  ...
  useEffect(() => {
    ...
    const attempts = Math.pow(58, value.length);
  ...
  const generateSingleWallet = async (signal) => {
    ...
    while (!signal.aborted) {
      ...
      if ((type === "prefix" && publicKeyB58.startsWith(value)) || (type === "suffix" && publicKeyB58.endsWith(value))) {
  ...
  return (
    <div id="generator" className="relative z-10 flex flex-col items-center justify-center h-auto p-6 text-white">
